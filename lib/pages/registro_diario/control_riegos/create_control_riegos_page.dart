...
class CreateControlRiesgosPage extends StatefulWidget {
  ...
  @override
  _CreateControlRiesgosPageState createState() =>
      _CreateControlRiesgosPageState();
}

class _CreateControlRiesgosPageState extends State<CreateControlRiesgosPage> {
  bool tieneUPP = false;
  ...
  void _guardarDatos() {
    if (numeroReporteEAController.text.isEmpty || fechaRegistroUlcera == null) {
    ...
    // Aquí puedes agregar la lógica para guardar los datos, por ejemplo, en Firebase o en una base de datos local
    print('Datos Guardados');
    print('Número de Reporte: ${numeroReporteEAController.text}');
    print('Fecha de Registro: ${fechaRegistroUlcera.toString()}');
    print('Control Mañana: ${mananaController.text}');
    print('Control Tarde: ${tardeController.text}');
    print('Control Noche: ${nocheController.text}');
