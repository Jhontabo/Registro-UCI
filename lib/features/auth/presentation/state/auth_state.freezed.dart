...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthResult authResult, User? user});
...
class _$AuthStateImpl implements _AuthState {
  _$AuthStateImpl(this.authResult, this.user);
  ...
  @override
  String toString() {
    return 'AuthState(authResult: $authResult, user: $user)';
  }
...
abstract class _AuthState implements AuthState {
  factory _AuthState(final AuthResult authResult, final User? user) =
      _$AuthStateImpl;
